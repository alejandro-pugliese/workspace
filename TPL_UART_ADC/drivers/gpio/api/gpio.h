 ...
 * @return		void
 ******************************************************************************/
#define GPIO_SETpIN(portNum, pinNum, activity) 				(((PIN_ACTIVITY)activity == ACTIVE_HIGH) ? \
 ...
 * @return		void
 ******************************************************************************/
#define GPIO_CLRpIN(portNum, pinNum, activity) 				(((PIN_ACTIVITY)activity == ACTIVE_HIGH) ? \
		                                            		(((LPC_GPIO_TypeDef *)LPC_GPIO_BASE+portNum)->FIOCLR |= (0x01 << pinNum)) : \
		                                            		(((LPC_GPIO_TypeDef *)LPC_GPIO_BASE+portNum)->FIOSET |= (0x01 << pinNum)))
