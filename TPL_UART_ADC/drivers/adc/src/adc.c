...
void ADC_Init(){
	// Implementar la inicializacion del canal 5 para que lea en forma automatica (modo BURST).
...
uint32_t ADC_GetValue(){
	// Implementar la funcion para leer el ADC una vez que la conversion termino.
...
ConversionCuentasAVariable(int resultado = 0)
{
