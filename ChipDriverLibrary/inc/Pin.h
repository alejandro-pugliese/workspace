...
#define PORT_3		 3
#define PORT_4		 4
#define PARAM_PORT(value) ((value >= PORT_0) && (value <= PORT_4))
...
#define PIN_30		30
#define PIN_31		31
#define PARAM_PIN(value) ((value >= PIN_0) && (value <= PIN_31))
 ...
 **********************************************************************************************************************************/
typedef enum {DEFAULT_FUNC = 0, FIRST_ALT_FUNC = 1, SECOND_ALT_FUNC = 2, THIRD_ALT_FUNC = 3} PinFunction_e;
#define PARAM_PINFUNC(value) ((value >= DEFAULT_FUNC) && (value <= THIRD_ALT_FUNC))

typedef enum {RES_PULL_UP = 0, RES_LAST_STATE = 1, RES_NONE = 2, RES_PULL_DOWN = 3} PinResistorMode_e;
#define PARAM_RESMODE(value) ((value >= RES_PULL_UP) && (value <= RES_PULL_DOWN))

typedef enum {NOT_OPEN_DRAIN = 0, OPEN_DRAIN = 1} PinOpenDrainMode_e;
#define PARAM_PINODMODE(value) ((value == NOT_OPEN_DRAIN) || (value == OPEN_DRAIN))
