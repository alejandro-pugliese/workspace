...
/*------------- System Control (SC) ------------------------------------------*/
#define FLASHCFG	(*((__IO uint32_t *)0x400FC000UL)) 	/* Flash access configuration */
#define PLL0CON		(*((__IO uint32_t *)0x400FC080UL))	/* Registro de control del PLL0	*/
#define	PLL0CFG		(*((__IO uint32_t *)0x400FC084UL))	/* Registro de configuracion del PLL0 */
#define	PLL0STAT	(*((__I uint32_t *)0x400FC088UL))	/* Registro de estado del PLL0 */
#define	PLL0FEED	(*((__O uint32_t *)0x400FC08CUL))	/* Registro de control del PLL0 */
#define	PLL1CON		(*((__IO uint32_t *)0x400FC0A0UL))	/* Registro de control del PLL1 */
#define	PLL1CFG		(*((__IO uint32_t *)0x400FC0A4UL))	/* Registro de configuracion del PLL1 */
#define	PLL1STAT	(*((__I uint32_t *)0x400FC0A8UL))	/* Registro de estado del PLL1 */
#define	PLL1FEED	(*((__O uint32_t *)0x400FC0ACUL))	/* Registro de control del PLL1 */
#define SC_PCONP	    (*((__IO uint32_t *)0x400FC0C4UL))	/* Registro de Control de Alimentación de Periféricos */
#define CCLKCFG		(*((__IO uint32_t *)0x400FC104UL))	/* Registro de configuracion del clock */
#define USBCLKCFG	(*((__IO uint32_t *)0x400FC108UL))	/* Registro de Configuración de Clock de USB */
#define CLKSRCSEL	(*((__IO uint32_t *)0x400FC10CUL))	/* Registro de seleccion del clock */
#define SCS			(*((__IO uint32_t *)0x400FC1A0UL))	/* Registro de control de sistema y registro de status */
#define SC_PCLKSEL0	(*((__IO uint32_t *)0x400FC1A8UL))	/* Registro de Selección de Clock de Periféricos 0 */
#define SC_PCLKSEL1	(*((__IO uint32_t *)0x400FC1ACUL))	/* Registro de Selección de Clock de Periféricos 1 */
#define CLKOUTCFG	(*((__IO uint32_t *)0x400FC1C8UL))	/* Registro de Configuración de Salida de Clock */
/**
 * @}
 */
