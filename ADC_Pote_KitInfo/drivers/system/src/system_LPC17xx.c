...
void SystemInit (void)
{
  ...
  SC_PCLKSEL0  = PCLKSEL0_Val;     /* Peripheral Clock Selection         */
  SC_PCLKSEL1  = PCLKSEL1_Val;
  ...
  SC_PCONP     = PCONP_Val;        /* Power Control for Peripherals      */

  CLKOUTCFG = CLKOUTCFG_Val;    /* Clock Output Configuration         */

  FLASHCFG  = (FLASHCFG & ~0x0000F000) | FLASHCFG_Val; /* Flash Accelerator Setup            */
}
