...
* @brief	Módulo para manejo del teclado fijo.
*
* @version	1.00
* @date		XX/XX/XXXX
...
*** PRIVATE DEFINES
********************************************************************************************************/
#define SW10_HW PORT_2, PIN_13
#define SW13_HW PORT_1, PIN_26
...
{
	GPIO_InitPinAsGPIO(SW10_HW, DIR_IN, RES_NONE, NOT_OPEN_DRAIN);
	GPIO_InitPinAsGPIO(SW13_HW, DIR_IN, RES_NONE, NOT_OPEN_DRAIN);
}
...
bool_t TECLADOFIJO_INFOTRONIC_LeerTecla(TECLAS tecla)
{
	...
	{
		case SW13:
			retval = GPIO_GETpINsTATE(SW13_HW, ACTIVE_LOW);
			break;
		case SW10:
			retval = GPIO_GETpINsTATE(SW10_HW, ACTIVE_LOW);
			break;
		default:
			break;
	}
